/*
  Code for a 3d printed car model which he wanted to bring to life.
  - battery powered via relay
  - RC control 
    - switching on blinkers leds and mp3 module with car wrooming sounds
    - blinkers with the mp3 module key openning sound
*/
